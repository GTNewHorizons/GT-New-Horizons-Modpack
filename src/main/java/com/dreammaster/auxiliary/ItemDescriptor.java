...
public class ItemDescriptor
{
	...
	public String getModID() { return mModID; };
	public String getItemName() { return mItemName; };
	public int getMeta() { return mMetaID; };
	
	public ItemDescriptor() { this("", "", 0); };
	public ItemDescriptor(String pModID, String pItemName){ this(pModID, pItemName, 0); }
	...
	public ItemStack getItemStack(int pAmount)
	{
		...
		Item tItem = getItem();
		if (tItem != null)
			tRetStack = new ItemStack(tItem, pAmount, mMetaID);
	...
	/**
	 * Get an ItemStack instance with given amount of items and NBT Tag
	 * pTag is optional, and this function will return an ItemStack without NBT if pTag is empty
	 * @param pAmount
	 * @param pTag
	 * @return
	 */
