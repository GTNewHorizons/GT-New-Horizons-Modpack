 ...
 *
 */
public class BloodyIchoriumProperties implements IExtendedBlockProperties
{
    @Override
    ...
    @Override
    public float getHardness() { return 120.0F; }
    ...
    @Override
    public String getBlockName() { return "BloodyIchorium"; }
