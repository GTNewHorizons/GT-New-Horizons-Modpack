 ...
 *
 */
public class QuadrupleCompressedCharcoalProperties implements IExtendedBlockProperties
{
    @Override
    ...
    @Override
    public float getResistance() { return 70.0F; }

    @Override
    public String getBlockName() { return "QuadrupleCompressedCharcoal"; }
