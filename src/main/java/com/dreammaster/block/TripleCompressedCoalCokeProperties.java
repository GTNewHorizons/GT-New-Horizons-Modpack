 ...
 *
 */
public class TripleCompressedCoalCokeProperties implements IExtendedBlockProperties
{
    @Override
    ...
    @Override
    public float getResistance() { return 60.0F; }

    @Override
    public String getBlockName() { return "TripleCompressedCoalCoke"; }
