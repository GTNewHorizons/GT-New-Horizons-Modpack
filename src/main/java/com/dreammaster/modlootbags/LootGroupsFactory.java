...
public class LootGroupsFactory 
{
     ...
     * @param pGroupName The name (doesn't have to be unique, but is recommended to be so) that is displayed ingame to the player
     ...
     * @param pTrashCombine Defaults to true. If set to false, this group is not combined with group 0 and will only drop items from this group
     * @return
     */
    ...
    /**
     * Create a drop Entry
     * @param pItemName The Minecraft-Notation of the item you want to add. Use modID:itemname:metaID The MetaID can be omitted if it is :0
     * @param pIdentifier The unique identifier to keep track of any player drops. this is only used when LimitedDropCount is > 0
     ...
     * @param pChance The weight of this itemdrop. The higher the value, the higher the chance that this item will drop
     * @param pLimitedDropCount Set to 0 to disable. If > 0, then the player will only get a maximum of pLimitedDropCount of this item
     * @return
     */
     ...
     * @param pChance The weight of this itemdrop. The higher the value, the higher the chance that this item will drop
     * @param pLimitedDropCount Set to 0 to disable. If > 0, then the player will only get a maximum of pLimitedDropCount of this item
     * @param pItemGroupName The optional ItemGroup name. If set to something else than an empty string. this item will always drop TOGETHER with all items that have the same GroupID. Note: This bypasses the maxItem amount
     * @return
     */
