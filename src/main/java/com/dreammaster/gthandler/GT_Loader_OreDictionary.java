...
public class GT_Loader_OreDictionary extends gregtech.loaders.preload.GT_Loader_OreDictionary
    ...
    public void run() {
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.ingot, Materials.Unstable, GT_ModHandler.getModItem("ExtraUtilities", "unstableingot", 1L, 0));
        GT_OreDictUnificator.registerOre(OrePrefixes.nugget, Materials.Unstable, GT_ModHandler.getModItem("ExtraUtilities", "unstableingot", 1L, 1));
        GT_OreDictUnificator.registerOre(OrePrefixes.ingot, Materials.Unstable, GT_ModHandler.getModItem("ExtraUtilities", "unstableingot", 1L, 2));
