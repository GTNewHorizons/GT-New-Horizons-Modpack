...
public class ItemPipes {
    ...
    public static void registerPipes()
    {
        ...
        // Plastic
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeTiny.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5589, "GT_Pipe_Tin_Tiny", "Tiny Rubber Item Pipe", 0.25F, Materials.Rubber, 1, 262144, false, 160).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeSmall.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5590, "GT_Pipe_Tin_Small", "Small Rubber Item Pipe", 0.375F, Materials.Rubber, 1,131072,false, 80).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeMedium.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5591, "GT_Pipe_Tin", "Tin Rubber Pipe", 0.5F, Materials.Rubber, 1,65536,false, 40).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeLarge.get(Materials.Rubber), new GT_MetaPipeEntity_Item(5592, "GT_Pipe_Tin_Large", "Large Rubber Item Pipe", 0.75F, Materials.Rubber, 1,32768,false).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeHuge.get(Materials.Rubber), new GT_MetaPipeEntity_Item(5593, "GT_Pipe_Tin_Huge", "Huge Rubber Item Pipe", 1.0F, Materials.Rubber, 2,16384,false).getStackForm(1L));

        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveTiny.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5594, "GT_Pipe_Restrictive_Tin_Tiny", "Tiny Restrictive Rubber Item Pipe", 0.25F, Materials.Rubber, 1, 26214400, true, 160).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveSmall.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5595, "GT_Pipe_Restrictive_Tin_Small", "Small Restrictive Rubber Item Pipe", 0.375F, Materials.Rubber, 1,13107200,true, 80).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveMedium.get(Materials.Rubber), new GT_CustomMetaPipeEntity_Item(5596, "GT_Pipe_Restrictive_Tin", "Tin Restrictive Item Rubber", 0.5F, Materials.Rubber, 1,6553600,true, 40).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveLarge.get(Materials.Rubber), new GT_MetaPipeEntity_Item(5597, "GT_Pipe_Restrictive_Tin_Large", "Large Restrictive Rubber Item Pipe", 0.75F, Materials.Rubber, 1,3276800,true).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveHuge.get(Materials.Rubber), new GT_MetaPipeEntity_Item(5598, "GT_Pipe_Restrictive_Tin_Huge", "Huge Restrictive Rubber Item Pipe", 1.0F, Materials.Rubber, 2,1638400,true).getStackForm(1L));
