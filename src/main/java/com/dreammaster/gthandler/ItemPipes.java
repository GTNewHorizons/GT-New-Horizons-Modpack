...
public class ItemPipes {
    ...
    public static void registerPipes()
    {
        ...
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveTiny.get(Materials.Tin), new GT_CustomMetaPipeEntity_Item(5594, "GT_Pipe_Restrictive_Tin_Tiny", "Tiny Tin Item Pipe", 0.25F, Materials.Tin, 1, 26214400, true, 160).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveSmall.get(Materials.Tin), new GT_CustomMetaPipeEntity_Item(5595, "GT_Pipe_Restrictive_Tin_Small", "Small Tin Item Pipe", 0.375F, Materials.Tin, 1,13107200,true, 80).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveMedium.get(Materials.Tin), new GT_CustomMetaPipeEntity_Item(5596, "GT_Pipe_Restrictive_Tin", "Tin Item Pipe", 0.5F, Materials.Tin, 1,6553600,true, 40).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveLarge.get(Materials.Tin), new GT_MetaPipeEntity_Item(5597, "GT_Pipe_Restrictive_Tin_Large", "Large Tin Item Pipe", 0.75F, Materials.Tin, 1,3276800,true).getStackForm(1L));
        GT_OreDictUnificator.registerOre(OrePrefixes.pipeRestrictiveHuge.get(Materials.Tin), new GT_MetaPipeEntity_Item(5598, "GT_Pipe_Restrictive_Tin_Huge", "Huge Tin Item Pipe", 1.0F, Materials.Tin, 2,1638400,true).getStackForm(1L));
