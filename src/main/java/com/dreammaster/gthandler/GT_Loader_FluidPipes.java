...
public class GT_Loader_FluidPipes
{
	...
	private void registerHighTierPipes()
	{
		...
		GT_OreDictUnificator.registerOre(OrePrefixes.pipeHuge.get(Materials.DraconiumAwakened), new GT_MetaPipeEntity_Fluid(5244, "GT_Pipe_Awakened_Draconiumr_Huge", "Huge Awakened Draconium Fluid Pipe", 1.0F, Materials.DraconiumAwakened, 180000, 10000000, true).getStackForm(1L));
		...
		GT_OreDictUnificator.registerOre(OrePrefixes.pipeHuge.get(Materials.Infinity), new GT_MetaPipeEntity_Fluid(5254, "GT_Pipe_Infinity_Huge", "Huge Infinity Fluid Pipe", 1.0F, Materials.Infinity, 240000, 10000000, true).getStackForm(1L));
