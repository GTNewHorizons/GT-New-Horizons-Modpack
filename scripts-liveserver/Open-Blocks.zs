...
// --- Map Controller Module
AssemblerLiq.addRecipe(<OpenBlocks:generic:6>, <OpenComputers:item:32>, <dreamcraft:item.SimpleCircuitBoard>, <liquid:molten.redstone> * 144, 300, 30);

// --- Map Memory Module
AssemblerLiq.addRecipe(<OpenBlocks:generic:7>, <OpenBlocks:generic:6>, <gregtech:gt.metaitem.01:32700> * 4, <liquid:molten.redstone> * 144, 400, 30);

// --- Empty Map 1:1
Assembler.addRecipe(<OpenBlocks:emptyMap>.withTag({Scale: 0 as byte}), <OpenBlocks:generic:6>, <OpenBlocks:generic:7> * 4, 600, 30);

// --- Empty Map 1:2
AssemblerLiq.addRecipe(<OpenBlocks:emptyMap>.withTag({Scale: 1 as byte}), <OpenBlocks:emptyMap>.withTag({Scale: 0 as byte}), <gregtech:gt.metaitem.01:32700> * 4, <liquid:molten.tin> * 144, 600, 30);

// --- Empty Map 1:4
AssemblerLiq.addRecipe(<OpenBlocks:emptyMap>.withTag({Scale: 2 as byte}), <OpenBlocks:emptyMap>.withTag({Scale: 1 as byte}), <IC2:itemPartCircuit> * 3, <liquid:molten.redstone> * 144, 800, 30);

// --- Empty Map 1:8
AssemblerLiq.addRecipe(<OpenBlocks:emptyMap>.withTag({Scale: 3 as byte}), <OpenBlocks:emptyMap>.withTag({Scale: 2 as byte}), <gregtech:gt.metaitem.01:32702> * 3, <liquid:molten.redalloy> * 144, 1000, 30);

// --- Empty Map 1:16
AssemblerLiq.addRecipe(<OpenBlocks:emptyMap>.withTag({Scale: 4 as byte}), <OpenBlocks:emptyMap>.withTag({Scale: 3 as byte}), <IC2:itemPartCircuitAdv> * 3, <liquid:molten.glowstone> * 144, 1200, 30);

// --- Catographer
AssemblerLiq.addRecipe(<OpenBlocks:cartographer>, <OpenBlocks:generic:9>, <minecraft:ender_eye>, <liquid:ender> * 1000, 600, 120);

// --- Dev/Null
AssemblerLiq.addRecipe(<OpenBlocks:devnull>, <ExtraUtilities:trashcan>, <gregtech:gt.integrated_circuit:1> * 0, <liquid:ender> * 250, 300, 30);

// --- Pedometer
AssemblerLiq.addRecipe(<OpenBlocks:pedometer>, <minecraft:clock>, <IC2:itemPartCircuit> * 2, <liquid:molten.redstone> * 144, 200, 30);
...
// --- White Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator>, <OpenBlocks:elevator:*>, null, null, <liquid:dye.watermixed.dyewhite> * 144, 10000, 0, 0,  200, 20);

// --- Black Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:15>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyeblack> * 144, 10000, 0, 0, 200, 20);

// --- Red Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:14>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyered> * 144, 10000, 0, 0, 200, 20);

// --- Green Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:13>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyegreen> * 144, 10000, 0, 0, 200, 20);

// --- Brown Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:12>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyebrown> * 144, 10000, 0, 0, 200, 20);

// --- Blue Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:11>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyeblue> * 144, 10000, 0, 0, 200, 20);

// --- Purple Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:10>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyepurple> * 144, 10000, 0, 0, 200, 20);

// --- Cyan Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:9>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyecyan> * 144, 10000, 0, 0, 200, 20);

// --- Light Grey Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:8>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyelightgray> * 144, 10000, 0, 0, 200, 20);

// --- Dark Grey Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:7>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyegray> * 144, 10000, 0, 0, 200, 20);

// --- Pink Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:6>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyepink> * 144, 10000, 0, 0, 200, 20);

// --- Lime Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:5>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyelime> * 144, 10000, 0, 0, 200, 20);

// --- Yellow Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:4>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyeyellow> * 144, 10000, 0, 0, 200, 20);

// --- Light Blue Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:3>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyelightblue> * 144, 10000, 0, 0, 200, 20);

// --- Magenta Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:2>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyemagenta> * 144, 10000, 0, 0, 200, 20);

// --- Orange Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating:1>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyeorange> * 144, 10000, 0, 0, 200, 20);

// --- White Rotating Elevator
ChemicalBathLiq.addRecipe(<OpenBlocks:elevator_rotating>, <OpenBlocks:elevator_rotating:*>, null, null, <liquid:dye.watermixed.dyewhite> * 144, 10000, 0, 0, 200, 20);
...
// --- Golden Eye
ChemicalBathLiq.addRecipe(<OpenBlocks:goldenEye:100>, null, null, <minecraft:ender_eye>, <liquid:molten.gold> * 144, 10000, 0, 0, 200, 20);
