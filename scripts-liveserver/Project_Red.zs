...
// --- LZ Upgarde
AssemblerLiq.addRecipe(<ProjRed|Core:projectred.core.part:48>, <ProjRed|Core:projectred.core.part:47>, <gregtech:gt.metaitem.01:23501> * 2, <liquid:molten.redalloy> * 144, 300, 30);
...
// --- Routed Interface Pipe
AssemblerLiq.addRecipe(<ProjRed|Transportation:projectred.transportation.pipe:2>, <ProjRed|Transportation:projectred.transportation.pipe:1>, <gregtech:gt.metaitem.01:17086> * 4, <liquid:molten.redstone> * 576, 400, 30);

// --- Routed Crafting Pipe
//AssemblerLiq.addRecipe(<ProjRed|Transportation:projectred.transportation.pipe:3>, <ProjRed|Transportation:projectred.transportation.pipe:1>, <gregtech:gt.metaitem.01:17811> * 2, <liquid:molten.redstone> * 864, 400, 30);

// --- Routed Request Pipe
AssemblerLiq.addRecipe(<ProjRed|Transportation:projectred.transportation.pipe:4>, <ProjRed|Transportation:projectred.transportation.pipe:1>, <gregtech:gt.metaitem.01:17500> * 2, <liquid:molten.redstone> * 864, 400, 30);
...
// --- Routed Firewall Pipe
AssemblerLiq.addRecipe(<ProjRed|Transportation:projectred.transportation.pipe:6>, <ProjRed|Transportation:projectred.transportation.pipe:1>, <minecraft:magma_cream> * 4, <liquid:lava> * 4000, 400, 30);
...
// --- IC Chip
AssemblerLiq.addRecipe(<ProjRed|Fabrication:projectred.fabrication.icchip>, <IC2:itemPartCircuit>, <gregtech:gt.metaitem.01:17526>, <liquid:molten.redstone> * 144, 300, 30); 

// --- IC Blue Print
AssemblerLiq.addRecipe(<ProjRed|Fabrication:projectred.fabrication.icblueprint>, <gregtech:gt.metaitem.01:32712>, <gregtech:gt.metaitem.01:17526> * 4, <liquid:molten.redstone> * 144, 600, 30);
...
// --- Red Silicon Compound
Mixer.addRecipe(<ProjRed|Core:projectred.core.part:42>, null, <gregtech:gt.metaitem.01:2020>, <minecraft:redstone> * 8, null, null, null, 400, 30);

// --- Glowing Silicon Compound
Mixer.addRecipe(<ProjRed|Core:projectred.core.part:43>, null, <gregtech:gt.metaitem.01:2020>, <minecraft:glowstone_dust> * 8, null, null, null, 400, 30);

// --- Electrotine Silicon Compound
Mixer.addRecipe(<ProjRed|Core:projectred.core.part:58>, null, <gregtech:gt.metaitem.01:2020>, <ProjRed|Core:projectred.core.part:56> * 8, null, null, null, 400, 30);

// --- Electrotine Compound
Mixer.addRecipe(<ProjRed|Core:projectred.core.part:57>, null, <minecraft:iron_ingot>, <ProjRed|Core:projectred.core.part:56> * 8, null, null, null, 400, 30);
