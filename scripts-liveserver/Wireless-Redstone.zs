...
// --- Wireless Transceiver
AssemblerLiq.addRecipe(<WR-CBE|Core:wirelessTransceiver>, <gregtech:gt.metaitem.01:23316>, <WR-CBE|Core:retherPearl>, <liquid:molten.redalloy> * 144, 600, 120);

// --- Blaze Transceiver
AssemblerLiq.addRecipe(<WR-CBE|Core:blazeTransceiver>, <minecraft:blaze_rod>, <WR-CBE|Core:retherPearl>, <liquid:molten.redalloy> * 144, 600, 120);
...
// --- Triangulatior
AssemblerLiq.addRecipe(<WR-CBE|Addons:triangulator>, <minecraft:compass>, <WR-CBE|Core:wirelessTransceiver>, <liquid:molten.redalloy> * 144, 600, 120);

// --- Wireless Map
AssemblerLiq.addRecipe(<WR-CBE|Addons:map>, <WR-CBE|Addons:triangulator>, <minecraft:paper> * 8, <liquid:molten.redstone> * 144, 300, 64);

// --- Tracker
AssemblerLiq.addRecipe(<WR-CBE|Addons:tracker>, <gregtech:gt.metaitem.01:17804> * 3, <WR-CBE|Core:wirelessTransceiver>, <liquid:molten.redalloy> * 144, 600, 120);

// --- REP
AssemblerLiq.addRecipe(<WR-CBE|Addons:rep>, <WR-CBE|Core:blazeTransceiver> * 2, <WR-CBE|Core:retherPearl> * 2, <liquid:obsidian.molten> * 1440, 600, 120);
