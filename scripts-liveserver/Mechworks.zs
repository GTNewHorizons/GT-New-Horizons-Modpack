...
// --- Advances Drawbridge
AssemblerLiq.addRecipe(<TMechworks:RedstoneMachine:2>, <TMechworks:RedstoneMachine>, <gregtech:gt.blockmachines:9241>, <liquid:molten.redstone> * 576, 600, 30);
...
// --- Signal Bus
AssemblerLiq.addRecipe(<TMechworks:SignalBus>, <TMechworks:LengthWire> * 3, <gregtech:gt.integrated_circuit:1> * 0, <liquid:molten.redstone> * 432, 200, 30);

// --- Signal Terminal
AssemblerLiq.addRecipe(<TMechworks:SignalTerminal>, <TMechworks:SignalBus> * 2, <gregtech:gt.integrated_circuit:2> * 0, <liquid:molten.glass> * 288, 300, 30);
