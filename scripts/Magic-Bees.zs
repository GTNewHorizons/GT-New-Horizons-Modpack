...
game.setLocalization("zh_CN", "tc.research_name.MAGICAPIARY", "Magic Apiary");
game.setLocalization("en_US", "tc.research_text.MAGICAPIARY", "[MB] Magical Apiary.");
game.setLocalization("zh_CN", "tc.research_text.MAGICAPIARY", "[MB] Magical Apiary.");
...
game.setLocalization("zh_CN", "MagicBees.research_page.MAGICAPIARY", "The Magic Apiary works similarly to the regular Apiary, with 1x base Territory, Mutation, Lifespan, and Flowering modifiers, 0.9x Production modifier, and 0.8 Genetic Decay modifier. When an Apiary Booster of any type is placed nearby, the Apiary will consume aspects to enable 2x (or 1/2) boosts for, in order from left to right: Mutation, Death Rate, Production. Enabling death rate will halve lifespan. Its useful when all youre interested in is breeding, and dont have access to Oblivion Frames.");
...
game.setLocalization("zh_CN", "tc.research_name.CONCENTRATEDCOMPOUND", "Concentrated Compound");
game.setLocalization("en_US", "tc.research_text.CONCENTRATEDCOMPOUND", "[MB] Concentrated Compound.");
game.setLocalization("zh_CN", "tc.research_text.CONCENTRATEDCOMPOUND", "[MB] Concentrated Compound.");
...
game.setLocalization("zh_CN", "MagicBees.research_page.CONCENTRATEDCOMPOUND", "Concentrated Compound from Apatite");
...
game.setLocalization("en_US", "tc.research_name.GENTLEFRAME", "Gentle Frame");
game.setLocalization("zh_CN", "tc.research_name.GENTLEFRAME", "Gentle Frame");
game.setLocalization("en_US", "tc.research_text.GENTLEFRAME", "[MB] Magic Living Frame");
game.setLocalization("zh_CN", "tc.research_text.GENTLEFRAME", "[MB] Magic Living Frame");
...
game.setLocalization("en_US", "tc.research_name.RESILIENTFRAME", "Resilient Frame");
game.setLocalization("zh_CN", "tc.research_name.RESILIENTFRAME", "Resilient Frame");
game.setLocalization("en_US", "tc.research_text.RESILIENTFRAME", "[MB] Magic Production Frame");
game.setLocalization("zh_CN", "tc.research_text.RESILIENTFRAME", "[MB] Magic Production Frame");
...
game.setLocalization("en_US", "tc.research_name.NECROTICFRAME", "Necrotic Frame");
game.setLocalization("zh_CN", "tc.research_name.NECROTICFRAME", "Necrotic Frame");
game.setLocalization("en_US", "tc.research_text.NECROTICFRAME", "[MB] Magic Killing Frame");
game.setLocalization("zh_CN", "tc.research_text.NECROTICFRAME", "[MB] Magic Killing Frame");
...
game.setLocalization("en_US", "tc.research_name.METABOLICFRAME", "Metabolic Frame");
game.setLocalization("zh_CN", "tc.research_name.METABOLICFRAME", "Metabolic Frame");
game.setLocalization("en_US", "tc.research_text.METABOLICFRAME", "[MB] Magic Drug Frame");
game.setLocalization("zh_CN", "tc.research_text.METABOLICFRAME", "[MB] Magic Drug Frame");
...
game.setLocalization("en_US", "tc.research_name.TEMPORALFRAME", "Temporal Frame");
game.setLocalization("zh_CN", "tc.research_name.TEMPORALFRAME", "Temporal Frame");
game.setLocalization("en_US", "tc.research_text.TEMPORALFRAME", "[MB] Magic Time Frame");
game.setLocalization("zh_CN", "tc.research_text.TEMPORALFRAME", "[MB] Magic Time Frame");
...
game.setLocalization("en_US", "tc.research_name.OBLIVIONFRAME", "Oblivion Frame");
game.setLocalization("zh_CN", "tc.research_name.OBLIVIONFRAME", "Oblivion Frame");
game.setLocalization("en_US", "tc.research_text.OBLIVIONFRAME", "[MB] Magic Production Frame");
game.setLocalization("zh_CN", "tc.research_text.OBLIVIONFRAME", "[MB] Magic Production Frame");
...
game.setLocalization("zh_CN", "tc.research_name.ENCHANTEDEARTH", "Enchanted Earth");
game.setLocalization("en_US", "tc.research_text.ENCHANTEDEARTH", "[MC] Magical Dirt");
game.setLocalization("zh_CN", "tc.research_text.ENCHANTEDEARTH", "[MC] Magical Dirt");
