...
game.setLocalization("zh_CN", "tc.research_name.BLOODALTAR", "Blood Altar");
game.setLocalization("en_US", "tc.research_text.BLOODALTAR", "Paying the highest price.");
game.setLocalization("zh_CN", "tc.research_text.BLOODALTAR", "Paying the highest price.");
...
game.setLocalization("zh_CN", "bloodmagic.research_page.BLOODALTAR", "The Blood Altar is the central block in Blood Magic. It is used for crafting, for generating Life Essence and for transferring life essence into a Soul Network.");
