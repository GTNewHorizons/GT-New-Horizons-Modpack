...
// --- Carbon Parts Helmet
//Assembler.addRecipe(<dreamcraft:item.CarbonPartHelmet>, <IC2:itemPartCarbonPlate> * 5, <gregtech:gt.integrated_circuit:5> * 0, 400, 120);

// --- Carbon Parts Helmet Night Vision
//Assembler.addRecipe(<dreamcraft:item.CarbonPartHelmetNightVision>, <dreamcraft:item.CarbonPartHelmet>, <IC2:itemNightvisionGoggles:*>, 600, 256);
...
// --- Nano Rubber Boots
//Assembler.addRecipe(<dreamcraft:item.NanoRubberBoots>, <IC2:itemArmorNanoBoots:*>, <IC2:itemArmorRubBoots>, 800, 1024);
...
// -
Assembler.addRecipe(<dreamcraft:item.PistonPlate>, <CarpentersBlocks:blockCarpentersBlock>, <minecraft:fence>, 100, 30);
...
game.setLocalization("zh_CN", "tc.research_category.NEWHORIZONS", "New Horizons");
...
game.setLocalization("zh_CN", "tc.research_name.WITHERRING", "Wither Protection Ring");
game.setLocalization("en_US", "tc.research_text.WITHERRING", "[NH] Wither...? It is star farming time");
game.setLocalization("zh_CN", "tc.research_text.WITHERRING", "[NH] Wither...? It is star farming time");
...
game.setLocalization("zh_CN", "NewHorizons.research_page.WITHERRING", "The Wither Protection Ring is a very special ring. Now you find a way to rid of the nasty withering effect. With this Ring it is time to farm some Netherstars. Good luck!!!");
...
game.setLocalization("zh_CN", "tc.research_name.EMINENCESTONE", "Carved Imminence Stone");
game.setLocalization("en_US", "tc.research_text.EMINENCESTONE", "[EU] Portal Stones");
game.setLocalization("zh_CN", "tc.research_text.EMINENCESTONE", "[EU] Portal Stones");
...
game.setLocalization("zh_CN", "ExtraUtilities.research_page.EMINENCESTONE", "The Portal Stone for the Last Millennium Portal or only for decoration.");
...
game.setLocalization("zh_CN", "tc.research_name.PORTALMILLENIUM", "Portal to the last Millennium");
game.setLocalization("en_US", "tc.research_text.PORTALMILLENIUM", "[EU] Night and Void");
game.setLocalization("zh_CN", "tc.research_text.PORTALMILLENIUM", "[EU] Night and Void");
...
game.setLocalization("zh_CN", "ExtraUtilities.research_page.PORTALMILLENIUM", "This place is known as The Last Millenium. All life, energy, knowledge, passion, struggle, philosophy and meaning is just a few short centuries from being rendered fully pointless. On the plus side, rent is very cheap now.");
...
game.setLocalization("zh_CN", "tc.research_name.PORTALDEEPDARK", "Portal to the Deep Dark");
game.setLocalization("en_US", "tc.research_text.PORTALDEEPDARK", "[EU] Deep, Deeper, Deep Dark");
game.setLocalization("zh_CN", "tc.research_text.PORTALDEEPDARK", "[EU] Deep, Deeper, Deep Dark");
...
game.setLocalization("zh_CN", "ExtraUtilities.research_page.PORTALDEEPDARK", "As an experienced miner you naturally wish to mine deeper and further than ever before into areas of natural wealth. The deep dark is a realm far below the void, filled with natural resources and deadly enemies. Some say that the darkness within this realm is alive and will consume any unlucky adventurer who wanders too far into it. Remember to bring torches. Torches will not protect you completely, however since mobs will spawn at all light levels in the Deep Dark. Magnum torches and Chandeliers will still prevent mob spawning.");
...
game.setLocalization("zh_CN", "tc.research_name.MAGICALWOOD", "Magical Wood");
game.setLocalization("en_US", "tc.research_text.MAGICALWOOD", "[EU] Twilight Thaumcraft Magic");
game.setLocalization("zh_CN", "tc.research_text.MAGICALWOOD", "[EU] Twilight Thaumcraft Magic");
...
game.setLocalization("zh_CN", "ExtraUtilities.research_page.MAGICALWOOD", "Magical Wood is an ingredient in the crafting of the Ender Core. It can be placed near an Enchantment Table to boost the level the table can enchant at by five levels. The amount of magical wood made from the crafting recipe depends on the strength of the enchantments on the Enchanted Books. For example, 4x Protection I gives a single piece of Magical Wood, whereas 4x Protection IV gives 14 pieces of wood.");
...
game.setLocalization("zh_CN", "tc.research_name.ANGELBLOCK", "Angel Block");
game.setLocalization("en_US", "tc.research_text.ANGELBLOCK", "[EU] A Block in the Air");
game.setLocalization("zh_CN", "tc.research_text.ANGELBLOCK", "[EU] A Block in the Air");
...
game.setLocalization("zh_CN", "ExtraUtilities.research_page.ANGELBLOCK", "The Angel Block is a block added by the Extra Utilities mod. This block is unique in that it does not need another block for it to be built against, so it can be placed in mid-air. When right-clicking the block will be placed in the direction youre looking. The block cant be placed diagonally in mid-air. No tool is required to break the block and it is broken instantly, even without any tools. After breaking the block does not drop, but rather instantly returns to the players inventory.");
...
game.setLocalization("zh_CN", "tc.research_name.DEZILSMARSHMALLOW", "Dezils Marshmallow");
game.setLocalization("en_US", "tc.research_text.DEZILSMARSHMALLOW", "[DE] OP food please");
game.setLocalization("zh_CN", "tc.research_text.DEZILSMARSHMALLOW", "[DE] OP food please");
...
game.setLocalization("zh_CN", "de.research_page.DEZILSMARSHMALLOW", "The ultimative Power of Food. You can swimm in Lava, diving like a fish, mine like crazy or jump like a rabbit. Eating on of the Marshmallow and you never get hungry again. You feeling like you can hit the Dragon with just bare Hands");
...
game.setLocalization("zh_CN", "tc.research_name.ENCHANTINGTABLE", "Enchanting Table");
game.setLocalization("en_US", "tc.research_text.ENCHANTINGTABLE", "[MC] Oh, its more magical than a Table!");
game.setLocalization("zh_CN", "tc.research_text.ENCHANTINGTABLE", "[MC] Oh, its more magical than a Table!");
...
game.setLocalization("zh_CN", "Minecraft.research_page.ENCHANTINGTABLE", "An enchantment table is a block that allows players to spend their experience point levels to enchant tools, books and armor. The enchanting tables main purpose is to enchant items. Bookshelves surrounding the table, with a block of air in between, will increase the maximum enchantment level. The table will enchant all tools and armor except the hoe, shears, flint and steel, lead and horse armor. The hoe and shears cannot be enchanted by the enchantment table and require an anvil and an appropriate enchanted book.");
...
game.setLocalization("zh_CN", "tc.research_name.BREWINGSTAND", "Brewing Stand");
game.setLocalization("en_US", "tc.research_text.BREWINGSTAND", "[MC] Oh, its more magical than a Cauldron!");
game.setLocalization("zh_CN", "tc.research_text.BREWINGSTAND", "[MC] Oh, its more magical than a Cauldron!");
mods.thaumcraft.Research.addPrereq("BREWINGSTAND", "INFUSION", false);
mods.thaumcraft.Research.setConcealed("BREWINGSTAND", false);
...
game.setLocalization("zh_CN", "brewingstand.research_page.BREWINGSTAND.1", "Brewing (or Alchemy) is the process of creating potions and splash potions by adding various ingredients to water bottles in a brewing stand. By placing bottles in the lower three slots of the brewing interface and an ingredient in the upper slot, you can distill the ingredient into the bottles and brew potions which may be consumed to grant an effect to the player. Every potion starts with a water bottle, made by filling a glass bottle at a water source or filled cauldron. The next step is to add a primary ingredient to create a base potion, which is usually Nether Wart, which creates an awkward potion and has no effects.");
...
game.setLocalization("zh_CN", "brewingstand.research_page.BREWINGSTAND.2", "By brewing a second ingredient into a base potion in the same manner, you can create a potion with a working effect. A third ingredient may be added to make the effect more intense or last longer, or turn the effect harmful. Finally, gunpowder can be added to a potion at any stage to convert it to a splash potion, which can be thrown (or fired using a dispenser) to disperse its effect in a radius. Each brewing step takes 20 seconds. Brewing can create very useful and lifesaving items. A good number of them are useful in combat by aiding the player or weakening enemies while others can save the players life if used quickly, like Fire Resistance or Healing.");
...
game.setLocalization("zh_CN", "Minecraft.research_page.BREWINGSTAND.3", "Gathering the Blaze Rods and Nether Wart necessary for brewing can prove challenging, but once they are set up, most potion ingredients are fairly plentiful and brewing will be a rewarding task.");
...
game.setLocalization("zh_CN", "tc.research_name.BEACON", "Beacon");
game.setLocalization("en_US", "tc.research_text.BEACON", "[MC] Oh, its more magical than a Diamond Block!");
game.setLocalization("zh_CN", "tc.research_text.BEACON", "[MC] Oh, its more magical than a Diamond Block!");
...
game.setLocalization("zh_CN", "Minecraft.research_page.BEACON", "A beacon is a unique block that projects a light beam skyward and can provide status effects to players in the vicinity. Beacon blocks can function as light sources, emitting a light level 15. Like other light sources, they will melt snow and ice. When activated, beacon blocks provide two unique functions: An aesthetic landmark beam reaching into the sky, which can be visible from far away. Powers, which give players status effects within a certain range.");
...
game.setLocalization("zh_CN", "tc.research_name.DRAGONEGG", "Dragon Egg");
game.setLocalization("en_US", "tc.research_text.DRAGONEGG", "[MC] Dragon Egg duplication");
game.setLocalization("zh_CN", "tc.research_text.DRAGONEGG", "[MC] Dragon Egg duplication");
...
game.setLocalization("zh_CN", "Minecraft.research_page.DRAGONEGG", "Dragon Eggs are dropped by Enderdragons when they are killed. When Right Clicked they teleport a short distance. Now you find a magical way to duplicate this Powerful Item using Draconis Bee Products and The Essence of false Life inside the Infusion Table");
...
game.setLocalization("zh_CN", "tc.research_name.SILKYCRYSTAL", "Silky Jevel");
game.setLocalization("en_US", "tc.research_text.SILKYCRYSTAL", "[TC] Silky magical.");
game.setLocalization("zh_CN", "tc.research_text.SILKYCRYSTAL", "[TC] Silky magical.");
...
game.setLocalization("zh_CN", "TConstruct.research_page.SILKYCRYSTAL", "Silky Cloth is a manufactured item and is a component of the Silky Jewel.<BR><BR>The Silky Jewel is a manufactured item, used to simulate the Silk Touch enchantment in TC tools.");
...
game.setLocalization("zh_CN", "tc.research_name.LAVACRYSTAL", "Lava Crystal");
game.setLocalization("en_US", "tc.research_text.LAVACRYSTAL", "[TC] Fiery magical.");
game.setLocalization("zh_CN", "tc.research_text.LAVACRYSTAL", "[TC] Fiery magical.");
...
game.setLocalization("zh_CN", "TConstruct.research_page.LAVACRYSTAL", "A Lava Crystal is a modifier both for tools and weapons. If added, the tool(s) is/are granted with the power of a furnace, meaning it will auto-smelt blocks when harvested. However, adding this to a weapon will not give it the same effect. Instead, it will set mobs on fire for 3 seconds.<BR>This modifier can be stacked with Luck (Fortune) and is not compatible with Silky (Silk Touch).");
...
game.setLocalization("zh_CN", "tc.research_name.BALLOFMOSS", "Ball of Moss");
game.setLocalization("en_US", "tc.research_text.BALLOFMOSS", "[TC] Your Tools repair itselfs.");
game.setLocalization("zh_CN", "tc.research_text.BALLOFMOSS", "[TC] Your Tools repair itselfs.");
...
game.setLocalization("zh_CN", "TConstruct.research_page.BALLOFMOSS", "The Ball of Moss for Tinkers Construct Tools.<BR> Attaching moss to a tool infuses it with life. The tool appers to be capable of regenerating wear and tear.<BR>Effects:<BR> The tool slowly repair itself.<BR>Sunlight speeds up the process.");
...
game.setLocalization("zh_CN", "tc.research_name.NECROTICBONE", "Necrotic Bone");
game.setLocalization("en_US", "tc.research_text.NECROTICBONE", "[TC] Evil way to make Wither Skeleton Bones.");
game.setLocalization("zh_CN", "tc.research_text.NECROTICBONE", "[TC] Evil way to make Wither Skeleton Bones.");
...
game.setLocalization("zh_CN", "tc.research_name.REDHEART", "Red Heart");
game.setLocalization("en_US", "tc.research_text.REDHEART", "[TC] 10 Hearts are not enough.");
game.setLocalization("zh_CN", "tc.research_text.REDHEART", "[TC] 10 Hearts are not enough.");
...
game.setLocalization("en_US", "tc.research_name.REDHEARTCANISTER", "Red Heart Canister");
game.setLocalization("zh_CN", "tc.research_name.REDHEARTCANISTER", "Red Heart Canister");
game.setLocalization("en_US", "tc.research_text.REDHEARTCANISTER", "[TC] Bounded in a small Box.");
game.setLocalization("zh_CN", "tc.research_text.REDHEARTCANISTER", "[TC] Bounded in a small Box.");
...
game.setLocalization("zh_CN", "tc.research_name.YELLOWHEART", "Yellow Heart");
game.setLocalization("en_US", "tc.research_text.YELLOWHEART", "[TC] 20 Hearts are not enough.");
game.setLocalization("zh_CN", "tc.research_text.YELLOWHEART", "[TC] 20 Hearts are not enough.");
...
game.setLocalization("en_US", "tc.research_name.YELLOWHEARTCANISTER", "Yellow Heart Canister");
game.setLocalization("zh_CN", "tc.research_name.YELLOWHEARTCANISTER", "Yellow Heart Canister");
game.setLocalization("en_US", "tc.research_text.YELLOWHEARTCANISTER", "[TC] Bounded in a Box.");
game.setLocalization("zh_CN", "tc.research_text.YELLOWHEARTCANISTER", "[TC] Bounded in a Box.");
...
game.setLocalization("zh_CN", "tc.research_name.GREENHEART", "Green Heart");
game.setLocalization("en_US", "tc.research_text.GREENHEART", "[TC] 30 Hearts are not enough.");
game.setLocalization("zh_CN", "tc.research_text.GREENHEART", "[TC] 30 Hearts are not enough.");
...
game.setLocalization("en_US", "TConstruct.research_page.GREENHEART.1", "The Miniature Green Heart is an item from Tinkers Construct. It can be made via Infusion. Its primary use is in crafting the Geen Heart Canister, but it can also be eaten to restore 30 life.");
game.setLocalization("zh_CN", "TConstruct.research_page.GREENHEART.1", "The Miniature Green Heart is an item from Tinkers Construct. It can be made via Infusion. Its primary use is in crafting the Geen Heart Canister, but it can also be eaten to restore 30 life.");
...
game.setLocalization("en_US", "tc.research_name.GREENHEARTCANISTER", "Green Heart");
game.setLocalization("zh_CN", "tc.research_name.GREENHEARTCANISTER", "Green Heart");
game.setLocalization("en_US", "tc.research_text.GREENHEARTCANISTER", "[TC] Bounded in a big Box.");
game.setLocalization("zh_CN", "tc.research_text.GREENHEARTCANISTER", "[TC] Bounded in a big Box.");
...
game.setLocalization("zh_CN", "tc.research_name.WARPWARNING", "Warp Warnings");
game.setLocalization("en_US", "tc.research_text.WARPWARNING", "[WT] Wither in the Overworld");
game.setLocalization("zh_CN", "tc.research_text.WARPWARNING", "[WT] Wither in the Overworld");
...
game.setLocalization("zh_CN", "WARPTHEORY.research_page.WARPWARNING.1", "Thaumcraft offers considerable power from its devices and tools. But power comes with a price.... As of version 4.2, that price is represented by Warp: A corruption of the characters mind and soul, inflicting progressively more dire effects upon them. While the effects of warp can range from annoying to deadly, accumulating enough of it can also grant you access to greater power... at the cost of increasing madness, and attention from dark powers. At least, others may call it madness... but is it truly insanity, when the voices in your head grant useful knowledge, and the monsters that appear before you leave remains behind?");
...
game.setLocalization("zh_CN", "WARPTHEORY.research_page.WARPWARNING.2", "Warp Theory add a bunch of new Warp Effects to the Player. Be very carful because you don't want autospawning an Wither in or bside you Base<BR>Warp Effects are Trickert by Warp Level<BR>Fake explosion warp effect can happen with 10 Warp<BR>Fake creeper warp effect can happen with 10 Warp<BR>Rain warp effect can happen with 12 Warp<BR>Spawn bats can happen with 15 Warp<BR>Poison warp effect can happen with 16 Warp");
...
game.setLocalization("zh_CN", "WARPTHEORY.research_page.WARPWARNING.3", "Jump boost warp effect can happen with 18 Warp<BR>Blood warp effect can happen with 25 Warp<BR>Nausea warp effect can happen with 25 Warp<BR>Friendly creeper warp effect can happen with 26 Warp<BR>Lightning warp effect can happen with 30 Warp<BR>Livestock rain warp effect can happen with 32 Warp<BR>Wind warp effect can happen with 38 Warp<BR>Blindness warp effect can happen with 43 Warp");
...
game.setLocalization("zh_CN", "WARPTHEORY.research_page.WARPWARNING.4", "Random teleport can happen with 45 Warp<BR>Acceleration warp effect can happen with 50 Warp<BR>Decay warp effect can happen with 50 Warp<BR>Random trees effect can happen with 50 Warp<BR>Chest scramble warp effect can happen with 80 Warp<BR>Spawn wither warp effect can happen with Warp 80");
...
game.setLocalization("zh_CN", "tc.research_name.ENDERCHEST", "Ender Chest");
game.setLocalization("en_US", "tc.research_text.ENDERCHEST", "[EC] Oh, its more magical than a Chest!");
game.setLocalization("zh_CN", "tc.research_text.ENDERCHEST", "[EC] Oh, its more magical than a Chest!");
...
game.setLocalization("zh_CN", "EnderStorage.research_page.ENDERCHEST", "The Ender Chest is a block that allows the player to store 27 items much like a wooden chest however, if two Ender Chests are placed down in different places, the items inside chest A will be in chest B. If the items are taken from either chest, both of the chest will not have that item. While on SMP, players will not share the same storage. This can be used to prevent players form stealing more valuable items, as they cannot access the same a items. This also means two players can store items in the same ender chest.");
...
game.setLocalization("zh_CN", "tc.research_name.ENDERTANK", "Ender Tank");
game.setLocalization("en_US", "tc.research_text.ENDERTANK", "[EC] Oh, its more magical than a Tank!");
game.setLocalization("zh_CN", "tc.research_text.ENDERTANK", "[EC] Oh, its more magical than a Tank!");
...
game.setLocalization("zh_CN", "EnderStorage.research_page.ENDERTANK", "The Ender Tank offers stationary storage for up to 16 buckets of a single liquid. Like the Ender Chest, it has three wool pads on top which can be manipulated by right-clicking each one with a dye. Tanks with matching colors will share liquids between them, even across dimensions. Additionally, right-clicking the dial with a diamond will set that tank to a private network for that player, change the dial to a diamond color, and show your username in the tooltip. A private Ender Tank will not share any liquids with any public tank, or any private tank from another user, even if the colored pads match.");
...
game.setLocalization("zh_CN", "tc.research_name.ENDERPOUCHE", "Ender Pouch");
game.setLocalization("en_US", "tc.research_text.ENDERPOUCHE", "[EC] Oh, its more magical than a Backpack!");
game.setLocalization("zh_CN", "tc.research_text.ENDERPOUCHE", "[EC] Oh, its more magical than a Backpack!");
...
game.setLocalization("zh_CN", "EnderStorage.research_page.ENDERPOUCHE", "The Ender Pouch is a craftable item offering remote access to any Ender Chest via right-clicking while holding the pouch. The Ender Pouch may be initially crafted with the desired color of wool; shift-right clicking on an Ender Chest with an Ender Pouch will synchronize the color code of the pouch to match the color code of the chest, replacing the previous color code of the pouch. When the ender-pouchs GUI is open, it is still possible to move it in your inventory, including moving it into the ender-pouch. Unlike bag-like things from other mods, it is then possible to retrieve it and its contents, by using an ender-chest or another ender-pouch with the same code.");
...
game.setLocalization("zh_CN", "tc.research_name.AUTOENCHANTINGTABLE", "Auto Enchanting Table");
game.setLocalization("en_US", "tc.research_text.AUTOENCHANTINGTABLE", "[OB] Auto Enchanting nice");
game.setLocalization("zh_CN", "tc.research_text.AUTOENCHANTINGTABLE", "[OB] Auto Enchanting nice");
...
game.setLocalization("zh_CN", "OpenBlocks.research_page.AUTOENCHANTINGTABLE.1", "An Auto Enchantment Table can draw the experience from a Tank using the auto drink setting, this is then stored in its internal liquid buffer before usage. Theres also a setting to automatically pull items to work on from an inventory on some side of the enchantment table, as well as resources or books to combine them with. A final setting allows for ejecting the finished item into an inventory at some side of the enchantment table. All of the settings can be set to work with certain sides of the block, this is done by left-clicking the sides of the enchantment table model shown in the individual settings panels.");
...
game.setLocalization("zh_CN", "OpenBlocks.research_page.AUTOENCHANTINGTABLE.2", " The enchantment table model in the panels can also be rotated by holding the right mouse button and dragging the cursor around.");
...
game.setLocalization("zh_CN", "tc.research_name.LUGGAGE", "Luggage");
game.setLocalization("en_US", "tc.research_text.LUGGAGE", "[OB] Luggage follow me");
game.setLocalization("zh_CN", "tc.research_text.LUGGAGE", "[OB] Luggage follow me");
...
game.setLocalization("zh_CN", "OpenBlocks.research_page.LUGGAGE.1", "Luggage is a storage block added by OpenBlocks. The block acts like a regular chest, but it is an entity. After a player places it down by right-clicking with it on the ground, it will start following them around. Right-clicking will open the inventory and it picks up items from the ground. By holding shift and right-clicking the luggage entity, it can be turned back into an item and picked up. When picked up, the luggage item will retain all content thats stored in it.");
...
game.setLocalization("zh_CN", "OpenBlocks.research_page.LUGGAGE.2", "Though the entity has 20 health points, it cant be hurt. Beware, as Luggage can still be burned by Lava or destroyed by cactus, though this is only in its item form, in entity form it is immune to fire and lava and even if pushed into the void will fall down next to its owner a moment later.Upon being struck by lightning, having a lightning focused wand from the Thaumcraft mod cast on it, or being blown up by a Charged Creeper, the Luggage will become supercharged, changing its texture, and doubling its inventory space.");
