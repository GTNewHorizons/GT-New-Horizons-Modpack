...
// --- Primordial Pearl out of Fragments
mods.thaumcraft.Research.addResearch("PRIMPEARL", "NEWHORIZONS", "auram 27, praecantatio 24, vitium 21, ordo 18, perditio 15, aer 12, ignis 9, terra 6, aqua 3", 4, -2, 4, <Thaumcraft:ItemEldritchObject:3>);
game.setLocalization("tc.research_name.PRIMPEARL", "Primordial Pearl");
game.setLocalization("tc.research_text.PRIMPEARL", "[TC] You found a magical Way of duplication");
//mods.thaumcraft.Research.addPrereq("PRIMPEARL", "PRIMORDRIALPEARL", false);
mods.thaumcraft.Research.addPrereq("PRIMPEARL", "ICHORIUM", false);
mods.thaumcraft.Research.setConcealed("PRIMPEARL", true);
mods.thaumcraft.Research.setRound("PRIMPEARL", true);
mods.thaumcraft.Research.addPage("PRIMPEARL", "tc.research_page.PRIMPEARL.1");
game.setLocalization("tc.research_page.PRIMPEARL.1", "You have started to understand how primodial pearls work and found a way to replicate them for future use. By hammering the primodial pearl into 3 pieces, you found that its losing energy really quickly. Perhaps, there is a way to reform each pieces them into a pearl.");
mods.thaumcraft.Infusion.addRecipe("PRIMPEARL", <dreamcraft:item.PrimordialPearlFragment>, 
...
mods.thaumcraft.Research.addInfusionPage("PRIMPEARL", <Thaumcraft:ItemEldritchObject:3>);
mods.thaumcraft.Warp.addToResearch("PRIMPEARL", 20);
