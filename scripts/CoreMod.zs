...
game.setLocalization("WARPTHEORY.research_page.WARPWARNING.2", "Warp theory adds a few new warp effects to you. <BR>Those warp effects are dependent on your level of warp and can seriously harm you or your surroundings. <BR>Fake explosion warp effect can happen with 10 Warp<BR>Fake creeper warp effect can happen with 10 Warp<BR>Spawn bats can happen with 15 Warp<BR>Poison warp effect can happen with 16 Warp<BR>Jump boost warp effect can happen with 18 Warp");
