...
game.setLocalization("zh_CN", "tc.research_name.DIMENSIONSHARDS", "Dimensional Shards");
game.setLocalization("en_US", "tc.research_text.DIMENSIONSHARDS", "[TT] Rarities of the Otherworld");
game.setLocalization("zh_CN", "tc.research_text.DIMENSIONSHARDS", "[TT] Rarities of the Otherworld");
...
game.setLocalization("zh_CN", "tt.research.page.DIMENSIONSHARDS", "Similarly to the overworld, the Nether and the End also have their specific shards, these are rarely held by either Zombie Pigmen living in the Nether or Endermen living in the End.<BR> You find a way to get this Shards with a Infusion recipe also.<BR><BR><IMG>ttinkerer:textures/items/netherShard.png:0:0:255:255:0.0625</IMG><IMG>ttinkerer:textures/items/enderShard.png:0:0:255:255:0.0625</IMG>");
...
game.setLocalization("zh_CN", "tc.research_name.CAPICHOR", "Ichorium Wand Caps");
game.setLocalization("en_US", "tc.research_text.CAPICHOR", "[TT] Somewhat like a Steam Sale");
game.setLocalization("zh_CN", "tc.research_text.CAPICHOR", "[TT] Somewhat like a Steam Sale");
...
game.setLocalization("zh_CN", "tt.research.page.CAPICHOR", "You have put Ichorium to its first ever use, by devising wand caps that give you a 30% discount on everything. Now you need to actually put this to any use and create a wand that can store more vis.");
