...
mods.thaumcraft.Research.addPage("DEZILSMARSHMALLOW", "NewHorizons.research_page.DEZILSMARSHMALLOW");
game.setLocalization("en_US", "NewHorizons.research_page.DEZILSMARSHMALLOW", "The ultimative Power of Food. You can swimm in Lava, diving like a fish, mine like crazy or jump like a rabbit. Eating on of the Marshmallow and you never get hungry again. You feeling like you can hit the Dragon with just bare Hands");
