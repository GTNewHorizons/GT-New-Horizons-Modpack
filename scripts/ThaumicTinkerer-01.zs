...
game.setLocalization("zh_CN", "tc.research_name.SHARETOME", "Tome of Knowledge Sharing");
game.setLocalization("en_US", "tc.research_text.SHARETOME", "[TT] A Goldfish's Diary");
game.setLocalization("zh_CN", "tc.research_text.SHARETOME", "[TT] A Goldfish's Diary");
...
game.setLocalization("zh_CN", "tt.research.page.SHARETOME", "If one day you happen to want to share your knowledge with the rest of the world, this is the item for you.<BR><BR>By simply right clicking on this tome and handing it to someone else, they'll get all the research you've discovered so far.<BR><BR>(Note: Case there being no recipe on the right of this, the recipe is disabled and the item is creative only)");
...
game.setLocalization("zh_CN", "tc.research_name.DARKQUARTZ", "Smokey Quartz");
game.setLocalization("en_US", "tc.research_text.DARKQUARTZ", "[TT] Shadow of the Day");
game.setLocalization("zh_CN", "tc.research_text.DARKQUARTZ", "[TT] Shadow of the Day");
...
game.setLocalization("zh_CN", "tt.research.page.DARKQUARTZ", "Smokey Quartz is pretty much Quartz, but negative. All regular blocks that can be made with quartz, can also be made with smokey quartz, and they look black.<BR><BR>Smokey Quartz itself can be made with a piece of coal or charcoal for tinting, and a few pieces of regular nether quartz.");
...
game.setLocalization("zh_CN", "tc.research_name.FIREIGNIS", "Elemental Fire: Ignis");
game.setLocalization("en_US", "tc.research_text.FIREIGNIS", "[TT] Fire infused with.....more fire!");
game.setLocalization("zh_CN", "tc.research_text.FIREIGNIS", "[TT] Fire infused with.....more fire!");
...
game.setLocalization("zh_CN", "tt.research.page.FIREIGNIS", "You have managed to enhance the destructive powers of hyperenergetic nitor. By letting this fire loose on the surface of the world, you can transmute blocks into their equivalent forms in the nether.");
...
game.setLocalization("zh_CN", "tc.research_name.FIREAQUA", "Elemental Fire: Aqua");
game.setLocalization("en_US", "tc.research_text.FIREAQUA", "[TT] Water plus Fire. This should end well.");
game.setLocalization("zh_CN", "tc.research_text.FIREAQUA", "[TT] Water plus Fire. This should end well.");
...
game.setLocalization("zh_CN", "tt.research.page.FIREAQUA", "You have managed to totally invert the destructive power of fire. This fire, when let loose in the nether, will turn it into your own personal winter wonderland.");
...
game.setLocalization("zh_CN", "tc.research_name.FIRETERRA", "Elemental Fire: Terra");
game.setLocalization("en_US", "tc.research_text.FIRETERRA", "[TT] Enough dirt to ... do whatever one does with dirt");
game.setLocalization("zh_CN", "tc.research_text.FIRETERRA", "[TT] Enough dirt to ... do whatever one does with dirt");
...
game.setLocalization("zh_CN", "tt.research.page.FIRETERRA", "This fire will turn a wide variety of blocks into dirt. Just about the least useful thing ever. Seriously. This is just about the least useful item ever.");
...
game.setLocalization("zh_CN", "tc.research_name.FIREORDO", "Elemental Fire: Ordo");
game.setLocalization("en_US", "tc.research_text.FIREORDO", "[TT] More ingots for your ore");
game.setLocalization("zh_CN", "tc.research_text.FIREORDO", "[TT] More ingots for your ore");
...
game.setLocalization("zh_CN", "tt.research.page.FIREORDO", "This fire, when let loose on a mountain of ores, will help you to process the ores into useful blocks of metal. While most of the ores will be consumed in the volatile fire, you will get thrice the amount of metal of mundane means of smelting.");
...
game.setLocalization("zh_CN", "tc.research_name.FIREAER", "Elemental Fire: Aer");
game.setLocalization("en_US", "tc.research_text.FIREAER", "[TT] Suspension of disbelief is a useful skill");
game.setLocalization("zh_CN", "tc.research_text.FIREAER", "[TT] Suspension of disbelief is a useful skill");
...
game.setLocalization("zh_CN", "tt.research.page.FIREAER", "Everyone likes desserts, right? Well, this fire, when let loose on the world, turns everything into a desert. That is almost like a dessert. Good enough?");
...
game.setLocalization("zh_CN", "tc.research_name.FIREPERDITIO", "Elemental Fire: Perditio");
game.setLocalization("en_US", "tc.research_text.FIREPERDITIO", "[TT] Cleanup time");
game.setLocalization("zh_CN", "tc.research_text.FIREPERDITIO", "[TT] Cleanup time");
...
game.setLocalization("zh_CN", "tt.research.page.FIREPERDITIO", "This fire acts like an antidote of sorts. If your elemental fires have gotten out of your control, you can set loose this specially designed flame. It will rip the magic out of elemental fire, returning it to a mundane form.");
...
game.setLocalization("zh_CN", "tc.research_name.INFUSEDSEED", "Infused Crops");
game.setLocalization("en_US", "tc.research_text.INFUSEDSEED", "[TT] Who said bees? No one said bees.");
game.setLocalization("zh_CN", "tc.research_text.INFUSEDSEED", "[TT] Who said bees? No one said bees.");
...
game.setLocalization("zh_CN", "tt.research.page.INFUSEDSEED.1", "You are able to create a new form of plant by infusing mundane seeds with magical shards. These seeds can create a wide variety of items. Each aspect can create a different type of item. You can only craft primal seeds, all others must be bred. When a fully-grown crop is harvested, it will deposit magical residue into the soil. If a crop is grown in soil containing high magical residue of an appropriate aspect, the two aspects will combine to form a seed of a different aspect.");
mods.thaumcraft.Research.addPage("INFUSEDSEED", "tt.research.page.INFUSEDSEED.2");
...
game.setLocalization("zh_CN", "tt.research.page.INFUSEDSEED.2", "Aspect Tendencies can also be bred into crops to increase certain traits. Terra will increase the magical residue left on the soil. Ignis will aid in the creation of new aspects. Ordo will increase the bounty from a plant. Perditio will increase the seeds dropped. Aer will allow a plant to receive other types of tendencies easier. A single plant can only have a maximum of 50 aspect tendencies. There are two ways to give crops primal tendencies. Crops will occasionally absorb primal tendencies if planted next to plants of the appropriate aspect. However, plants can't receive more than 5 points in a single aspect in this manner.");
...
game.setLocalization("zh_CN", "tt.research.page.INFUSEDSEED.3", "The other recipes are not shown but you can infuse Seeds with all the other Primal Aspect Crystals.<BR>Seeds infuse Ignis with Ignis Cluster and 16 ignis Aspect instead of Air, Seeds infuse Aqua with Aqua Crystals and 16 aqua Aspect instead of Air...");
...
game.setLocalization("zh_CN", "tc.research_name.INFUSEDPOTIONS", "Infused Poitions");
game.setLocalization("en_US", "tc.research_text.INFUSEDPOTIONS", "[TT] Grwoing your Poitions.");
game.setLocalization("zh_CN", "tc.research_text.INFUSEDPOTIONS", "[TT] Grwoing your Poitions.");
...
game.setLocalization("zh_CN", "tt.research.page.INFUSEDPOTIONS.1", "Crops will also drain tendencies from nearby crops. A crop will drain points from an adjacent crop with an equal or greater number of points. Some plants will create special grain, which can be made into potions. <BR> Earth infused potions summons barriers between mobs that attack you. <BR> Fire infused potions trap your enemies in a sphere of fire. <BR> Air infused potions send your enemies up in the air. <BR> Water infused potions chill surrounding lava.");
